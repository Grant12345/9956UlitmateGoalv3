...
public class Wobble {
    ...
    private static final double WOBBLE_ONE_OPEN = 0.07;
    private static final double WOBBLE_ONE_MINI = 0.28;
    private static final double WOBBLE_ONE_CLOSED = 0.37; //.38
    private static final double WOBBLE_TWO_OPEN = 0.64;
    private static final double WOBBLE_TWO_MINI = 0.61;
    private static final double WOBBLE_TWO_CLOSED = 0.3; //.38

    private static final double WOBBLE_MOTOR_ERROR = 0.1;

    public static final int WOBBLE_UP_TICKS = -320;
    public static final int WOBBLE_DOWN_TICKS = -1075;
